...
export default function Team( {teamRef}) {
  return (
    <div className= 'w-[100vw] h-[100vh] mission xs:h-[auto] ' >
        <div className='w-[90vw] m-[auto] flex flex-col items-center p-[50px] gap-[40px]' ref={teamRef} style={{ opacity: 0, transition: 'opacity 1s ease-in' }}>
          ...
          <div className='flex items-center justify-center gap-[30px] xs:flex-col ' >
            <div className='bg-[white] w-[25vw] h-[60vh] p-3 rounded-[20px] flex flex-col items-center justify-center gap-[10px] xs:w-[340px] '>
