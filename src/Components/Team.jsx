...
export default function Team( {teamRef}) {
  return (
    <div className= 'w-[100vw] h-[100vh] bg-[#7FC7D9]' >
        <div className='w-[90vw] m-[auto] flex flex-col items-center p-[50px] gap-[40px]'>
          <h1 className='text-[white] text-[45px] font-[600]'>Meet Out Team</h1>
          <div className='flex items-center justify-center gap-[30px] ' >
            <div className='bg-[white] w-[25vw] h-[60vh] p-3 rounded-[20px] flex flex-col items-center justify-center gap-[25px]'>
              <div className='h-[250px] w-[250px] mt-[15px]'>

                <img  src='images/tiffany.jpg' alt='Tiffany Gulumba' className='rounded-[20px] object-cover h-[260px] w-[280px]'/> 
              </div>
            ...
            <div className='bg-[white] w-[25vw] h-[60vh] p-3 rounded-[20px] flex flex-col items-center justify-center gap-[25px]'>
              <div className='h-[250px] w-[250px] mt-[15px] '>
                ...
                <img  src='images/sade.jpg' alt='Tiffany Gulumba' className='rounded-[20px]  object-cover h-[260px] w-[280px]'/>
              </div>
              <div className='text-center'>
