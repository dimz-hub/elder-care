...
export default function Hero({topRef}) {
  return (
    <div className= ' hero-body w-[90vw] m-[auto] p-[25px] mt-[60px] h-[50vh] xs:w-[100%] xs:h-[100vh] xs:items-center xs:flex  xs:justify-center xs:mt-[0px]' >
      <div className='w-[45vw] xs:w-[100%] xs:flex xs:flex-col xs:justify-center ' ref={topRef} style={{ opacity: 0, transition: 'opacity 1s ease-in' }}> 
      

      <h2 className='text-[44px] font-[600] text-[white] xs:text-[32px] xs:w-[100%] xs:mt-[20px] '>
 ...
 <Link to={'/enquiry'} className='xs:w-[90vw] xs:flex xs:justify-center xs:pt-[5px]'>
