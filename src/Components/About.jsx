...
const handleIntersection = (entries, section) => {
  ...
  return (
    ...
    <div className= '  h-[70vh] w-[100vw] flex items-center justify-center text-[white] text-[80px] text-center font-[500] xs:text-[40px] '   >
...
<div className= 'modern  xs:flex xs:flex-col xs:w-[90vw] xs:m-[auto] xs:justify-center '  ref={modernRef} style={{ opacity: 0, transition: 'opacity 1s ease-in' }}>
    ...
    <div className='w-[100vw] h-[40vh] bg-[#294B29] flex flex-col items-center justify-center'  ref={startRef} style={{ opacity: 0, transition: 'opacity 1s ease-in' }} >
         <h1 className='text-[white] font-[400] text-[45px] xs:text-[30px] xs:text-center'>Get started with Birch, today!😄</h1>
          <Link to={'/contact'}>
